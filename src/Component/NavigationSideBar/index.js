    ...
    return (
      <ThemeContext.Consumer>
        {value => {
          ...
          const onClickOption = tabName => {
            changeActiveTab(tabName)
          }

          return (
            <>
              <MobileNavSideBar isDarkTheme={isDarkTheme}>
                <NavLink to="/">
                  <NavMenuOptionItem
                    key="home"
                    bgColor={activeTab === 'Home' ? activeTabBgColor : 'none'}
                    onClick={() => onClickOption('Home')} // Fix here
                  >
                    <AiFillHome
                      size={25}
                ...
                <NavLink to="/trending">
                  <NavMenuOptionItem
                    ...
                    onClick={() => onClickOption('Trending')} // Fix here
                  >
                    <HiFire
                      size={25}
                ...
                <NavLink to="/gaming">
                  <NavMenuOptionItem
                    ...
                    onClick={() => onClickOption('Gaming')} // Fix here
                  >
                    <SiYoutubegaming
                      size={25}
                ...
                <NavLink to="/saved-videos">
                  <NavMenuOptionItem
                    ...
                    onClick={() => onClickOption('Saved')} // Fix here
                  >
                    <CgPlayListAdd
                      size={25}
